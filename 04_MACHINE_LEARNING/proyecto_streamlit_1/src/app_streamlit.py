...
from files import eda

image = Image.open('files/img/funding.png')
...
# Cargamos los modelos serializados
loaded_model_LR = joblib.load(open("models/loan_predition_model_LR.pkl", 'rb'))
loaded_model_RF = joblib.load(open("models/loan_predition_model_RF", 'rb'))
...
with st.sidebar:
    choose = option_menu("Menu", ["What is loan prediction?","About this project","Get predictions", "Loan Info","About the Creator"],
